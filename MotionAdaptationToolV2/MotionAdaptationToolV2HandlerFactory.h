...
class MotionAdaptationToolV2HandlerFactory : public MotionHandlerFactory
{
public:
    MotionAdaptationToolV2HandlerFactory();

    virtual ~MotionAdaptationToolV2HandlerFactory();
